change3++!+= Google App Engine Boilerplate
...
== Technologies used
* Python 2.7
* {NDB 1.0.1}[http://developers.google.com/appengine/docs/python/ndb/] (A new datastore API for the Google App Engine Python runtime).
